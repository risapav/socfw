...
//
// The scheduler outputs period_o one clock ahead of the corresponding
// TMDS symbol so the encoders have one cycle of setup time.
//
// Data-island timing (pixel clocks):
//   preamble     : 8 symbols
//   leading GB   : 2 symbols
//   payload      : 32 symbols  (packet_len_i must equal 32 for a full packet)
