/**
 * @file xfcp_test_07_axis_top.sv
 * @brief XFCP switch: UART + ETH-UDP, v0.9+STATUS+AXIS.
 ...
 *
 *   Rozsirenia oproti xfcp_test_06_top:
...
`define XFCP_TEST_07_AXIS_TOP_SV
...
`endif // XFCP_TEST_07_AXIS_TOP_SV
