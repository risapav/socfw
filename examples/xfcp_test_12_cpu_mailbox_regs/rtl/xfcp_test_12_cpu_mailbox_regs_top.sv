 ...
 *     Slot 7 @ 0xFF070000 : axil_cpu_mailbox (CPUM)
 *
 *   STREAM sloty:
 *     stream_id=0 (STR0): loopback FIFO 256 entries
 *     stream_id=1 (CPU0): axil_cpu_mailbox RX/TX FIFO
 *
...
`endif
  ...
  xfcp_fabric_endpoint #(
    ...
    .SLAVE_BASE('{
      ...
      32'hFF04_0000, 32'hFF05_0000, 32'hFF06_0000, 32'hFF07_0000
    }),
    .SLAVE_MASK('{
  ...
  // ── CPU0: axil_cpu_mailbox (stream_id=1, AXI-Lite @ 0xFF070000) ──
  logic [7:0] cpu0_m_tdata_w;
  logic       cpu0_m_tvalid_w, cpu0_m_tready_w, cpu0_m_tlast_w;
  ...
  axil_cpu_mailbox #(.FIFO_DEPTH(256)) u_cpu_mailbox (
    .clk_i          (clk_i),
    .rst_ni         (rst_ni),
    .s_axil         (axil_s[7].slave),
    .s_axis_tdata_i ({cpu0_m_tlast_w, cpu0_m_tdata_w}),
    .s_axis_tvalid_i(cpu0_m_tvalid_w),
    .s_axis_tready_o(cpu0_m_tready_w),
  ...
  xfcp_axis_adapter #(
    ...
    .m_axis_tdata_o  (cpu0_m_tdata_w),
    .m_axis_tvalid_o (cpu0_m_tvalid_w),
    .m_axis_tready_i (cpu0_m_tready_w),
    .m_axis_tlast_o  (cpu0_m_tlast_w),
    .s_axis_tdata_i  (cpu0_tx_data_w[7:0]),
    .s_axis_tvalid_i (cpu0_tx_valid_w),
    .s_axis_tready_o (cpu0_tx_ready_w),
    .s_axis_tlast_i  (cpu0_tx_data_w[8])
  );
  ...
  xfcp_target_info_adapter #(
    ...
    .TARGET_TYPE ('{
      ...
      8'h01   // 10: AXIL CPUM (axil_cpu_mailbox)
    }),
    .TARGET_BASE_ADDR ('{
      32'hFF00_0000,  // SYSC
      32'hFF01_0000,  // UART
      ...
      32'hFF07_0000   // CPUM axil_cpu_mailbox
    }),
    .TARGET_MAX_XFER ('{
    ...
    .TARGET_ALIGN ('{
      8'd4, 8'd4, 8'd4, 8'd4, 8'd4, 8'd4, 8'd4, 8'd4, 8'd4, 8'd4, 8'd4
    }),
    .TARGET_NAME ('{
      32'h53595343,  // "SYSC"
      32'h55415254,  // "UART"
