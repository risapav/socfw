...
module tb_acr_packet_builder;
  ...
  initial begin
    ...
    for (int sp = 0; sp < 4; sp++) begin
      chk8($sformatf("T1 sp%0d pb[0] CTS[7:0]",   sp), pb[sp*7+0], cts_val[7:0]);
      chk8($sformatf("T1 sp%0d pb[1] CTS[15:8]",  sp), pb[sp*7+1], cts_val[15:8]);
      chk8($sformatf("T1 sp%0d pb[2] CTS[19:16]", sp), pb[sp*7+2], {4'h0, cts_val[19:16]});
      chk8($sformatf("T1 sp%0d pb[3] reserved",   sp), pb[sp*7+3], 8'h00);
      chk8($sformatf("T1 sp%0d pb[4] N[7:0]",     sp), pb[sp*7+4], n_val[7:0]);
      chk8($sformatf("T1 sp%0d pb[5] N[15:8]",    sp), pb[sp*7+5], n_val[15:8]);
      chk8($sformatf("T1 sp%0d pb[6] N[19:16]",   sp), pb[sp*7+6], {4'h0, n_val[19:16]});
    end
    ...
    chk8("T4 sp0 pb[0]", pb[0], 8'h45);
    chk8("T4 sp0 pb[1]", pb[1], 8'h23);
    chk8("T4 sp0 pb[2]", pb[2], 8'h01);
    chk8("T4 sp0 pb[3]", pb[3], 8'h00);
    chk8("T4 sp0 pb[4]", pb[4], 8'hDE);
    chk8("T4 sp0 pb[5]", pb[5], 8'hBC);
    chk8("T4 sp0 pb[6]", pb[6], 8'h0A);
