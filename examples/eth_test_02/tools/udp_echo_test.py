...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="UDP echo test for FPGA eth_udp_echo_test\n"
                    "Required static ARP: sudo arp -s 192.168.20.50 00:0a:35:01:fe:c0",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ap.add_argument("--host",    default="192.168.20.50", help="FPGA IP address")
    ap.add_argument("--port",    type=int, default=8080, help="UDP echo port")
