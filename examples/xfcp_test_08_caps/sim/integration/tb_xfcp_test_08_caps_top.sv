...
// tb_xfcp_test_08_caps_top -- integration test for xfcp_test_08_caps_top.
//
...
module tb_xfcp_test_08_caps_top;
  import tb_eth_pkg::*;
  ...
  initial begin
    ...
    // Ocakavana odpoved: FD 02 seq 00 01 01 07 01 01 00 04 07 00
    ...
    begin
      ...
      chk8(caps[1], 8'h01, "T23.proto_minor==1");
      ...
      chk8(caps[7], 8'h07, "T23.caps_flags==0x07");
    end
    ...
    begin
      ...
      if (n >= 63) begin
        ...
        chk8(cap[55], 8'h01, "T24.proto_minor");
        ...
        chk8(cap[61], 8'h07, "T24.caps_flags");
      end
    end
    ...
    begin
      ...
      chk8(caps[7], 8'h07, "T25.caps_flags==0x07");
      // Then AXIL READ resp
      recv_read(rdata);
