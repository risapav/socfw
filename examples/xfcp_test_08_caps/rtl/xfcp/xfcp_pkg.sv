/**
 * @file    xfcp_pkg.sv
 * @brief   Definicia struktur a opkodov protokolu XFCP v1.1+CAPS.
 ...
 *            Byte 0: proto_major
 *            Byte 1: proto_minor
 *            Byte 2: num_axil_slots
 *            Byte 3: num_stream_slots
 *            Byte 4: max_stream_bytes[15:8]
 *            Byte 5: max_stream_bytes[7:0]
 *            Byte 6: stream_align
 *            Byte 7: caps_flags (bit0=AXIL, bit1=STREAM, bit2=CAPS)
 *
