...
// tb_xfcp_test_10_axifull_top -- integration test for xfcp_test_10_axifull_top.
//
...
// T23-T25: GET_CAPS (proto_minor=3, caps_flags=0x1F).
...
// T29:     GET_TARGET_INFO index=9 (invalid) -> BAD_ADDRESS.
...
module tb_xfcp_test_10_axifull_top;
  import tb_eth_pkg::*;
  ...
  initial begin
    ...
    // ==============================================================
    // T29: GET_TARGET_INFO index=9 (invalid, NUM_TARGETS=9) -> BAD_ADDRESS
    // ==============================================================
    $display("--- T29: GET_TARGET_INFO index=9 (invalid) -> BAD_ADDRESS ---");
    begin
      automatic logic [7:0] ti[16];
      automatic logic [7:0] status;
      xfcp_get_target_info(8'hD3, 8'h09);
      recv_get_target_info(ti, status);
