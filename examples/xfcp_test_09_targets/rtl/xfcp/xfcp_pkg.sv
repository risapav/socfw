/**
 * @file    xfcp_pkg.sv
 * @brief   Definicia struktur a opkodov protokolu XFCP v1.2+TARGETS.
 ...
 *
 *          Caps struct (8 bajtov, 2 x 32-bit slova MSB-first):
 *            Byte 0: proto_major   Byte 1: proto_minor
 *            Byte 2: num_axil_slots  Byte 3: num_stream_slots
 *            Byte 4-5: max_stream_bytes (big-endian)
 *            Byte 6: stream_align  Byte 7: caps_flags
 *
 ...
 *            Byte  0: target_type (0x01=AXIL, 0x02=STREAM)
 ...
 *
 *          STREAM_WRITE/READ (xfcp_test_07 obmedzenia):
 *            count musi byt nasobok 4 (32-bit granularita).
 *            addr[7:0] = stream_id (0 = loopback slot; inak UNSUPPORTED).
 */
