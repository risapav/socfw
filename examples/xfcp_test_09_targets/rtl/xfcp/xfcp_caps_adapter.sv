 ...
 *     Word 1 [ 7: 0] = CAPS_FLAGS (bit0=AXIL, bit1=STREAM, bit2=CAPS)
 *
 ...
 * @param CAPS_FLAGS        Bitova maska schopnosti (bit0=AXIL, bit1=STREAM, bit2=CAPS).
 */
...
module xfcp_caps_adapter #(
  ...
  parameter int CAPS_FLAGS       = 3'b111  // AXIL | STREAM | CAPS
)(
  input  wire clk,
  input  wire rst_n,
